...
// @dev Interface for an ERC721 compliant contract.
interface IERC721Diamond {
    ...
    /**
     * Cannot mint an existing tokenID.
     */
     ...
     * The token does not exist.
     */
    error BurnQueryForNonexistentToken();
    ...
    /**
     * @dev Safely transfers `id` token from `from` to `to`.
     *
     * Requirements:
     *
    ...
    /**
     * @dev Safely transfers `id` token from `from` to `to`, checking first that contract recipients
